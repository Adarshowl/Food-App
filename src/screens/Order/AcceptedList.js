...
const AcceptedList = ({navigation}) => {
  ...
  const getAcceptedList = () => {
    setLoading(true);
    try {
      // console.log("response axios >>> ", JSON.stringify(API_END_POINTS.Refund_Approve_List));

      ApiCall('get', null, API_END_POINTS.Refund_Approve_List, {
        ...
        .then(response => {
          ...
          if (response?.statusCode === 200) {
            // console.log("Response data: ", JSON.stringify(response.data));
            setAcceptedList(response?.data?.response);
