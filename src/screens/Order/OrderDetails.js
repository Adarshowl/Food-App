    ...
    <SafeAreaView
      ...
      >
        <View style={{
          ...
          <Text style={[styles?.shipout, {
            fontSize: 18,

          }]}>Bubar Ayam Pak Yono</Text>
          <Text style={[styles?.shipIn, {
            marginTop: 10,
            fontSize: 14,
            marginBottom: 10
          }]}>Ship to 9 West 45th Street, New York City</Text>
        </View>
        ...
        <View style={{
          ...
          <View style={{
            ...
            <Text style={[styles?.shipout, {
              marginLeft: 10
            }]}>JL. Sultan Hasanudin No. 123</Text>
          </View>
        </View>
            ...
            <View style={{
              ...
              <View style={{
                ...
                <Text
                  ...
                  {/* {shippingCharge} */}
                  Order delivered on January 3, 2:43 PM
                </Text>
